...
export default function LeaveApprovals() {
  ...
  const { data: pendingLeaves, isLoading: isLoadingLeaves } = useQuery<any[]>({
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-semibold mb-1">Leave & Attendance Approvals</h1>
          <p className="text-muted-foreground">
            Review and approve pending leave requests and attendance regularizations
          </p>
        </div>
      </div>
